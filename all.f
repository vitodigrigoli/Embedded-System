...
: ?GPFSEL 10# 9 <= IF GPFSEL0 ELSE 10# 19 <= IF GPFSEL1 ELSE 10# 29 <= IF GPFSEL2 ELSE 10# 39 <= IF GPFSEL3 ELSE 10# 49 <= IF GPFSEL4 ELSE 10# 57 <= IF GPFSEL5 ELSE ." ERROR" THEN THEN THEN THEN THEN THEN ;
: GPIO_MODE ;
