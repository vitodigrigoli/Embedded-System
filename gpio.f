...
: ALT_0 	SWAP 4 SWAP LSHIFT OR NIP ! ;
: ALT_1 	SWAP 5 SWAP LSHIFT OR NIP ! ;
: ALT_2 	SWAP 6 SWAP LSHIFT OR NIP ! ;
: ALT_3 	SWAP 7 SWAP LSHIFT OR NIP ! ;
: ALT_4 	SWAP 3 SWAP LSHIFT OR NIP ! ;
: ALT_5 	SWAP 2 SWAP LSHIFT OR NIP ! ;
