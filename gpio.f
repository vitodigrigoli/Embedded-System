...
: BIC 10 MOD 3 * DUP 7 SWAP LSHIFT INVERT 2OVER NIP AND ;

: GPIO_MODE  DUP ?GPFSEL DUP @ ROT BIC ;

: INPUT		SWAP 0 SWAP LSHIFT OR NIP SWAP ! ;
: OUTPUT 	SWAP 1 SWAP LSHIFT OR NIP SWAP ! ;
: ALT_0 	SWAP 4 SWAP LSHIFT OR NIP SWAP ! ;
: ALT_1 	SWAP 5 SWAP LSHIFT OR NIP SWAP ! ;
: ALT_2 	SWAP 6 SWAP LSHIFT OR NIP SWAP ! ;
: ALT_3 	SWAP 7 SWAP LSHIFT OR NIP SWAP ! ;
: ALT_4 	SWAP 3 SWAP LSHIFT OR NIP SWAP ! ;
: ALT_5 	SWAP 2 SWAP LSHIFT OR NIP SWAP ! ;
